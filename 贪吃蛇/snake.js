//获取绘制工具
   ...
   switch(e.keyCode)
		{
         case 37: if(togo==3)break;
		 togo=1; break;//←
		 case 38: if(togo==4)break;
		 togo=2; break;//↑
		 case 39: if(togo==1)break;
		 togo=3; break;//→
		 case 40: if(togo==2)break;
		 togo=4; break;//↓键
		}
   }
   ...
   function isDead()
   {
	...
	{
		if(snake[snakeCount-1].x==snake[k].x &&  snake[snakeCount-1].y==snake[k].y)
		{
			alert("You are dead,GAME OVER!!!");
			window.location.reload();
		}
